        ...
        <form action="MySQL/insert.php" method="POST" class="form" enctype="multipart/form-data">
            ...
            <div class="nome_telefone">
                <div class="nome">
                    ...
                    <input class="campo_1" name="Nome" type="text" placeholder="Digite seu nome completo" required>
                </div>

                <div class="telefone">
                    <p><b>Telefone</b></p>
                    <input class="campo_1" name="tefone" type="text" placeholder="(11) 99999-9999" required>
                </div>
            </div>
            <div class="telefone">
                    <p><b>CPF</b></p>
                    <input class="campo_1" name="cpf" type="text" placeholder="000.000.000-11" required>
                </div>

            <div class="email_endereco">
                <div class="email">
                    <p><b>E-mail</b></p>
                    <input class="campo_1" name="email" type="email" placeholder="exemplo@email.com" required>
                </div>

                <div class="endereco">
                    <p><b>Endereço</b></p>
                    <input class="campo_1" name="Local" type="text" placeholder="Rua, número, bairro, cidade - UF" required>
                </div>
            </div>
            ...
            <div class="tipo_servico">
                ...
                <div class="endereco">
                    ...
                    <input class="campo_1" name="tempo" type="text" placeholder="Ex:15 anos" required>
                </div>
            </div>
            ...
            <div class="email_endereco">
                ...
                <div class="endereco">
                    ...
                    <input class="campo_1" name="Salario" type="text" placeholder="2.000,00" required>
                </div>
            </div>
            <div class="endereco">
                    <p><b>Foto</b></p>
            ...
            <div class="Descricao">
                <p><b>Biografia</b></p>
                <textarea class="servico" name="descri" id="" placeholder="Nós fale um pouco sobre você" required></textarea>
            </div>
